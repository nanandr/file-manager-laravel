        ...
        <div class="modal-body p-0 py-3 px-3">
          <form method="post" action="" id="upload-image"> 
            ...
            <div class="form-group">
              ...
              <input value="{{ Auth::user()->full_name }}" type="text" name="full_name" class="form-control" placeholder="Full Name..">
            </div>

            <div class="form-group">
              <label>Username</label>
              <input value="{{ Auth::user()->username }}" type="text" name="full_name" class="form-control" placeholder="Full Name..">
            </div>

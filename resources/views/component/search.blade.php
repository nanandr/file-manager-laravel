<form class="form-group shadow-sm shadow-hover bg-light" action="{{ url('search') }}" method="GET">
    {{ csrf_field() }}
    <div class="d-flex border px-2 d-flex align-items-center" style="height: 50px">
        ...
        <a @if(!request()->is('home')) href="{{url('home')}}" @endif class="border-0 ml-auto text-dark" @if(request()->is('home') || isset($parent)) id="close" @endif style="cursor:pointer" onclick="closeButton()">

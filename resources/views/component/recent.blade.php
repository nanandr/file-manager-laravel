<div class="mb-2">
    ...
    <div class="inline-group px-3 collapse" id="collapseRecent">
        <div class="row pt-2 pb-3">
            ...
            <div class="card card-inline mx-2 shadow-sm shadow-hover">
                <a href="#" class="text-dark d-flex flex-column" style="padding: 0px">
                    <img src="{{ asset('img/test.jpg') }}" class="bg-light card-img">
                    <h6 class="pt-2 px-2">Modul Laravel.docx</h6>
                </a>
            </div>
            <div class="card card-inline mx-2 shadow-sm shadow-hover">
                <a href="#" class="text-dark d-flex flex-column" style="padding: 0px">
                    <img src="{{ asset('img/icon_pdf.png') }}" class="bg-light card-img px-5 py-4">
                    <h6 class="pt-2 px-2">Buku IPA Kelas XI.pdf</h6>
                </a>
            </div>
            <div class="card card-inline mx-2 shadow-sm shadow-hover">
                <a href="#" class="text-dark d-flex flex-column" style="padding: 0px">
                    <img src="{{ asset('img/icon_ppt.png') }}" class="bg-light card-img px-5 py-4">
                    <h6 class="pt-2 px-2">Modul Laravel.docx</h6>
                </a>
            </div>
            <div class="card card-inline mx-2 shadow-sm shadow-hover">
                <a href="#" class="text-dark d-flex flex-column" style="padding: 0px">
                    <img src="{{ asset('img/icon_exc.png') }}" class="bg-light card-img px-5 py-4">
                    <h6 class="pt-2 px-2">Modul Laravel.docx</h6>
                </a>
            </div>
            <div class="card card-inline mx-2 shadow-sm shadow-hover">
                <a href="#" class="text-dark d-flex flex-column" style="padding: 0px">
                    <img src="{{ asset('img/icon_audio.png') }}" class="bg-light card-img px-5 py-4">
                    <h6 class="pt-2 px-2">Modul Laravel.docx</h6>
                </a>
            </div>
            <div class="card card-inline mx-2 shadow-sm shadow-hover">
            ...
            <div class="card card-inline mx-2 shadow-sm shadow-hover">
                <a href="#" class="text-dark d-flex flex-column" style="padding: 0px">
                    <img src="{{ asset('img/icon_doc.png') }}" class="bg-light card-img px-5 py-4">
                    <h6 class="pt-2 px-2">Modul Laravel XI RPL B.docx</h6>
                </a>
            </div>
            <div class="card card-inline mx-2 shadow-sm shadow-hover">
                <a href="#" class="text-dark d-flex flex-column" style="padding: 0px">
                    <img src="{{ asset('img/icon_doc.png') }}" class="bg-light card-img px-5 py-4">
                    <h6 class="pt-2 px-2">10.docx</h6>
                </a>
            </div>
        </div>
    </div>

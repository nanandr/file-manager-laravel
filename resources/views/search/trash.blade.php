<form class="form-group shadow-sm shadow-hover bg-light" action="{{ url('search/trash') }}" method="GET">
    {{ csrf_field() }}
    <div class="d-flex border px-2 d-flex align-items-center" style="height: 50px">
        ...
        @if(request('keyword') !== null)
            <a href="{{url('trash')}}" class="border-0 ml-auto text-dark" style="cursor:pointer" onclick="closeButton()">
